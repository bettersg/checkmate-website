...
router.get("/publicmessages", async (req, res) => {
  ...
  if (req.query) {
    ...
    //if (req.query['categories']) {var categories = req.query['categories']} else {var categories = "illicit,legitimate,misinformation,scam,spam,trivial,unsure"}
    if (req.query['categories']) {var categories = req.query['categories']} else {var categories = "illicit,misinformation,scam,spam"}

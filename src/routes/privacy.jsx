      ...
      <div className="flex flex-col gap-y-6 text-[16px] md:text-[20px] text-checkGrayModal xl:max-w-[1280px] w-full p-6 md:p-12 items-start mx-auto font-workSans font-medium">
        ...
        >
          ...
          <div className="px-4 py-6 pt-0 ml-4 mt-4">
            ...
            <p className="text-[16px]"><span className=" text-checkPrimary600">Affiliate</span> means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</p>
            <p className="text-[16px]"><span className=" text-checkPrimary600">Application</span> refers to the CheckMate bot, the whatsapp bot as provided by the Organisation.</p>
            <p className="text-[16px]"><span className=" text-checkPrimary600">Organisation</span> (referred to as either “<span className="underline">Better.sg</span>”, "the Organisation", "We", "Us" or "Our" in this Agreement) refers to <span className="underline">BETTER.SG</span> LIMITED, 258F LORONG CHUAN, BOUNDARY GARDENS, 556755.</p>
            <p className="text-[16px]"><span className=" text-checkPrimary600">Country</span> refers to The Republic of Singapore</p>
            <p className="text-[16px]"><span className=" text-checkPrimary600">Device</span> means any device that can access the Service such as a computer, a cellphone or a digital tablet.</p>
            <p className="text-[16px]"><span className=" text-checkPrimary600">Personal Data</span> is any information that relates to an identified or identifiable individual.</p>
            <p className="text-[16px]"><span className=" text-checkPrimary600">Service</span> refers to the Application.</p>
            <p className="text-[16px]"><span className=" text-checkPrimary600">Service Provider</span> means any natural or legal person who processes the data on behalf of the Organisation. It refers to third-party companies or individuals employed by the Organisation or volunteers to the Organisation to facilitate the Service, to provide the Service on behalf of the Organisation, to perform services related to the Service or to assist the Organisation in analyzing how the Service is used.</p>
            <p className="text-[16px]"><span className=" text-checkPrimary600">Third-party Social Media Service</span> refers to any website or any social network website through which a User can log in or create an account to use the Service, for example Whatsapp.</p>
            <p className="text-[16px]"><span className=" text-checkPrimary600">Usage Data</span> refers to data collected automatically, either generated by the use of the Service or from the Service infrastructure itself (for example, the duration of a page visit).</p>
            <p className="text-[16px]"><span className=" text-checkPrimary600">You</span> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</p>            
          </div>
        </details>
        ...
        >
          ...
          <div className="px-4 py-6 pt-0 ml-4 mt-4">
            ...
            <p className="text-[16px]">When You access the Service by or through a mobile device, We may collect certain information automatically, including, but not limited to, the type of mobile device You use, Your mobile device unique ID, the IP address of Your mobile device, Your mobile operating system, the type of mobile Internet browser You use, unique device identifiers and other diagnostic data.</p>
            <p className="text-[16px]">We may also collect information that Your browser sends whenever You visit our Service or when You access the Service by or through a mobile device.</p>
            <h3 className="flex-1 text-[20px] text-checkGrayPrivacy pt-8">Information from Third-Party Social Media Services</h3>
            <div className="text-[16px]">The Organisation allows You to engage and use the Service through the following Third-party Social Media Services:<br/>
              <ul className="list-disc	pl-8"><li>Whatsapp</li></ul>
            </div>
            <p className="text-[16px]">If You decide to register through or otherwise grant us access to a Third-Party Social Media Service , We may collect Personal data that is already associated with Your Third-Party Social Media Service's account that is publicly available, such as Your name, Phone Number, or Your activities associated with that account.</p>
            <p className="text-[16px]">You may also have the option of sharing additional information with the Organisation through Your Third-Party Social Media Service's account. If You choose to provide such information and Personal Data, during registration or otherwise, You are giving the Organisation permission to use, share, and store it in a manner consistent with this Privacy Policy.</p>
            <h2 className="flex-1 text-[20px] text-checkGrayPrivacy pt-8 pb-6">Use of Your Personal Data</h2>
            <p className="text-[16px]">The Organisation may use Personal Data for the following purposes:</p>
            <p className="text-[16px]"><span className=" text-checkPrimary600">To provide and maintain our Service</span>, including to monitor the usage of our Service or messages forwarded or replied to the CheckMate bot for the purposes of providing our Service.</p>
            <p className="text-[16px]"><span className=" text-checkPrimary600">To manage Your Account</span>: to manage Your registration as a user of the Service. The Personal Data You provide can give You access to different functionalities of the Service that are available to You as a registered user.</p>
            <p className="text-[16px]"><span className=" text-checkPrimary600">For the performance of a contract</span>: the development, compliance and undertaking of the provision of the services, items or services You have purchased or of any other contract with Us through the Service.</p>
            <p className="text-[16px]"><span className=" text-checkPrimary600">To contact You</span>: To contact You by telephone calls, SMS, or other equivalent forms of electronic communication, such as a messaging you via Whatsapp or the Social Media services you have engaged with us regarding updates or informative communications related to the functionalities, products or contracted services, including the security updates, when necessary or reasonable for their implementation.</p>
            <p className="text-[16px]"><span className=" text-checkPrimary600">To provide You with news</span>, special offers and general information about other goods, services and events which we offer that are similar to those that you have already engaged with or enquired about unless You have opted not to receive such information.</p>
            <p className="text-[16px]"><span className=" text-checkPrimary600">To manage Your requests</span>: To attend and manage Your requests to Us.</p>
            <p className="text-[16px]"><span className=" text-checkPrimary600">For security purposes</span>: For security purposes or as per request of law enforcement agencies we may share data such as messages sent or forwarded to the CheckMate with government led organisations for the purpose of avoiding harmful messages reaching other users or for the purposes of investigations.</p>
            <p className="text-[16px]"><span className=" text-checkPrimary600">For other purposes</span>: We may use Your information for other purposes, such as data analysis, identifying usage trends, determining the effectiveness of our promotional campaigns and to evaluate and improve our Service, products, services, marketing and your experience.</p>
            <div className="text-[16px]">We may share Your personal information in the following situations:<br/>
            ...
            <h2 className="flex-1 text-[20px] text-checkGrayPrivacy pt-8 pb-6">Retention of Your Personal Data</h2>
            <p className="text-[16px]">The Organisation will retain Your Personal Data only for as long as is necessary for the purposes set out in this Privacy Policy. We will retain and use Your Personal Data to the extent necessary to comply with our legal obligations (for example, if we are required to retain your data to comply with applicable laws), resolve disputes, and enforce our legal agreements and policies.</p>
            <p className="text-[16px]">The Organisation will also retain Usage Data for internal analysis purposes. Usage Data is generally retained for a shorter period of time, except when this data is used to strengthen the security or to improve the functionality of Our Service, or We are legally obligated to retain this data for longer time periods.</p>
            <h2 className="flex-1 text-[20px] text-checkGrayPrivacy pt-8 pb-6">Transfer of Your Personal Data</h2>
            ...
            <h2 className="flex-1 text-[20px] text-checkGrayPrivacy pt-8 pb-6">Delete Your Personal Data</h2>
            ...
            <p className="text-[16px]">You may update, amend, or delete Your information at any time by contacting Us to request access to, correct, or delete any personal information that You have provided to Us.</p>
            ...
            <h2 className="flex-1 text-[20px] text-checkGrayPrivacy pt-8 pb-6">Disclosure of Your Personal Data</h2>
            <h3 className="flex-1 text-[20px] text-checkGrayPrivacy pt-8 pb-6">Business Transactions</h3>
            <p className="text-[16px]">If the Organisation is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
            <h3 className="flex-1 text-[20px] text-checkGrayPrivacy pt-8 pb-6">Law enforcement</h3>
            <p className="text-[16px]">Under certain circumstances, the Organisation may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
            <h3 className="flex-1 text-[20px] text-checkGrayPrivacy pt-8 pb-6">Other legal requirements</h3>
            <p className="text-[16px]">The Organisation may disclose Your Personal Data in the good faith belief that such action is necessary to:</p>
            <ul className="list-disc	pl-8 text-[16px]">
            ...
            <h2 className="flex-1 text-[20px] text-checkGrayPrivacy pt-8 pb-6">Security of Your Personal Data</h2>
        ...
        >
          ...
          <div className="px-4 py-6 pt-0 ml-4 mt-4 text-[16px]">

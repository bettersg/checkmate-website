  ...
  return (
    <div id="privacy" className={`flex flex-col items-start font-poppins`}>
      <div className="xl:max-w-[1280px] mx-auto w-full flex flex-col items-start px-6 md:px-12 pt-6 md:pt-20 text-checkBlack">
        ...
        <p className="text-[12px] md:text-[16px] font-workSans font-medium">
      ...
      <div className="flex flex-col gap-y-6 text-[16px] md:text-[20px] text-checkGrayModal xl:max-w-[1280px] w-full p-6 md:p-12 items-start mx-auto font-workSans font-medium">
        <p className="text-checkBlack">
          ...
          information in accordance with this Privacy Policy and Whatsapp’s
          privacy policy:
          <br />
          <a
            className="underline text-checkPrimary600"
        ...
        <details
          ...
          className="w-[90%] bg-checkWhite border border-checkPrimary600 md:px-12 py-4 rounded-[32px]"
          id="toggle1"
        >
          ...
          <div className="px-4 py-6 pt-0 ml-4 mt-4">
            <h2 className="flex-1 text-[20px] pt-12 pb-4 text-checkGrayPrivacy">
              Interpretation
            </h2>
            ...
            <h2 className="flex-1 text-[20px] pt-8 pb-4 text-checkGrayPrivacy">
              Definitions
            </h2>
            <p className="text-[16px]">
            ...
            <p className="text-[16px]">
              <span className=" text-checkPrimary600">Account</span> means a
            ...
            <p className="text-[16px]">
              ...
              to the CheckMate bot, the whatsapp bot as provided by the
              Organisation.
            </p>
            <p className="text-[16px]">
            ...
            <p className="text-[16px]">
              <span className=" text-checkPrimary600">Country</span> refers to
              The Republic of Singapore
            </p>
            <p className="text-[16px]">
              <span className=" text-checkPrimary600">Device</span> means any
              device that can access the Service such as a computer, a cellphone
              or a digital tablet.
            </p>
            <p className="text-[16px]">
              <span className=" text-checkPrimary600">Personal Data</span> is
              any information that relates to an identified or identifiable
              individual.
            </p>
            <p className="text-[16px]">
              <span className=" text-checkPrimary600">Service</span> refers to
              the Application.
            </p>
            <p className="text-[16px]">
              <span className=" text-checkPrimary600">Service Provider</span>{' '}
              means any natural or legal person who processes the data on behalf
              of the Organisation. It refers to third-party companies or
              individuals employed by the Organisation or volunteers to the
              Organisation to facilitate the Service, to provide the Service on
              behalf of the Organisation, to perform services related to the
              Service or to assist the Organisation in analyzing how the Service
              is used.
            </p>
            <p className="text-[16px]">
              ...
              a User can log in or create an account to use the Service, for
              example Whatsapp.
            </p>
            <p className="text-[16px]">
              <span className=" text-checkPrimary600">Usage Data</span> refers
            ...
            <p className="text-[16px]">
              <span className=" text-checkPrimary600">You</span> means the
        ...
        >
          ...
          <div className="px-4 py-6 pt-0 ml-4 mt-4">
            <h2 className="flex-1 text-[20px] text-checkGrayPrivacy pt-8">
              Types of Data Collected
            </h2>
            <h3 className="flex-1 text-[20px] text-checkGrayPrivacy pt-8">
              Personal Data
            </h3>
            ...
            <p className="text-[16px]">
              Usage Data will include data shared in interactions with the
            ...
            <div className="text-[16px]">
              The Organisation allows You to engage and use the Service through
            ...
            <p className="text-[16px]">
              ...
              , including to monitor the usage of our Service or messages
              forwarded or replied to the CheckMate bot for the purposes of
            ...
            <p className="text-[16px]">
              ...
              : the development, compliance and undertaking of the provision of
              the services, items or services You have purchased or of any other
              contract with Us through the Service.
            </p>
            <p className="text-[16px]">
              <span className=" text-checkPrimary600">To contact You</span>: To
              contact You by telephone calls, SMS, or other equivalent forms of
              electronic communication, such as a messaging you via Whatsapp or
              the Social Media services you have engaged with us regarding
            ...
            <p className="text-[16px]">
              ...
              you have already engaged with or enquired about unless You have
            ...
            <p className="text-[16px]">
              ...
              : For security purposes or as per request of law enforcement
              agencies we may share data such as messages sent or forwarded to
              the CheckMate with government led organisations for the purpose of
              avoiding harmful messages reaching other users or for the purposes
              of investigations.
            </p>
            <p className="text-[16px]">
              <span className=" text-checkPrimary600">For other purposes</span>:
            ...
            <div className="text-[16px]">
              ...
              <ul className="list-disc	pl-8 flex flex-col gap-y-2">
                ...
                <li>
                  ...
                  of Organisation assets, financing, or acquisition of all or a
                  portion of Our business to another company.
                </li>
                <li>
                  <span className=" text-checkPrimary600">With Affiliates</span>
                ...
                <li>
                  ...
                  offer You certain products or services.
                </li>
                <li>
                  <span className=" text-checkPrimary600">
                    With other users
                  </span>
                  : when You share messages with the CheckMate bot we will be
                  sharing these messages with volunteers, other members of Our
                  Organisation or other users of Whatsapp in order to provide
                  you with the Service and determine whether these messages are
                  harmful to you. Remember that if You interact with other users
                ...
                <li>
                  ...
                  : Messages that you have shared with checkmate may be be
                  anonymised of personally identifiable information (e.g.,
                  number, name, addresses) and stored in our database for the
                  purpose of tracking data related to scams and misinformation.
                  Said database can be made available to the public or other
                  checkmate users via our website or service.
                </li>
                <li>
                  <span className=" text-checkPrimary600">
                    With Your consent
            ...
            <p className="text-[16px]">
              The Organisation will retain Your Personal Data only for as long
            ...
            <p className="text-[16px]">
              The Organisation will also retain Usage Data for internal analysis
            ...
            <p className="text-[16px]">
              The Organisation will take all steps reasonably necessary to
              ...
              take place to an organization, company, or a country unless there
            ...
            <h3 className="flex-1 text-[20px] text-checkGrayPrivacy pt-8 pb-6">
              Business Transactions
            </h3>
            <p className="text-[16px]">
              If the Organisation is involved in a merger, acquisition or asset

  ...
  return (
    <div id="privacy" className={`flex flex-col items-start font-poppins`}>
      ...
      <div className="flex flex-col gap-y-6 text-xl text-checkBlack xl:max-w-[1280px] w-full p-12 items-start mx-auto">
        ...
        <div id="toggle1" className="bg-checkWhite border border-checkPrimary600 p-12 rounded-[32px]">
          <h1 className="flex-1  ss:text-[36px] text-checkPrimary600 text-[24px] pt-8">Interpretation and Definitions</h1>
          ...
          <h1 className="flex-1  ss:text-[48px] text-[36px]  pt-8">Collecting and Using Your Personal Data</h1>
        ...
        <div id="toggle2" className="bg-checkWhite border border-checkPrimary600 p-12 rounded-[32px]">
          <h1 className="flex-1 ss:text-[36px] text-checkPrimary600 text-[24px] pb-6">Children's Privacy</h1>
        ...
        <div id="toggle3" className="bg-checkWhite border border-checkPrimary600 p-12 rounded-[32px]">
          <h1 className="flex-1 ss:text-[36px] text-checkPrimary600 text-[24px] pb-6">Links to Other Websites</h1>
          <p>Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party's site. We strongly advise You to review the Privacy Policy of every site You visit.</p>
          <p>We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.</p>
        </div>

        <div id="toggle4" className="bg-checkWhite border border-checkPrimary600 p-12 rounded-[32px]">
          <h1 className="flex-1 ss:text-[36px] text-checkPrimary600 text-[24px] pb-6">Changes to this Privacy Policy</h1>
          <p>We may update Our Privacy Policy from time to time. We will notify You of any changes by posting the new Privacy Policy on this page.</p>
          <p>We will let You know via email and/or a prominent notice on Our Service, prior to the change becoming effective and update the "Last updated" date at the top of this Privacy Policy.</p>
          <p>You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective when they are posted on this page.</p>
        </div>

        <div id="toggle5" className="bg-checkWhite border border-checkPrimary600 p-12 rounded-[32px]">
          <h1 className="flex-1 ss:text-[36px] text-checkPrimary600 text-[24px] pb-6">Contact Us</h1>

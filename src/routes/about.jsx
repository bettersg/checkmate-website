    ...
    <div className="w-full bg-checkBG font-poppins flex flex-col items-center">
      <div className="flex flex-col justify-center">
        <div className="xl:max-w-[1280px] w-full flex flex-col px-10 md:px-20 mx-auto">
          ...
          <h1 className="font-light text-checkPrimary600 ss:text-[56px] text-[48px]">
          ...
          <h1 className="font-light text-checkPrimary600 ss:text-[48px] text-[32px] mt-12">
            What is CheckMate?
          </h1>
          <p className="text-xl">
        ...
        <div className="xl:max-w-[1280px] w-full flex flex-col mx-auto items-center">
          <h1 className="w-3/4 md:w-1/2 ss:text-[48px] text-[32px] font-bold content-center text-center">
            Meet our{" "}
          ...
          <p className="w-1/2 mt-4 text-gray-700">

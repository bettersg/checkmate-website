    ...
    <div className="w-full bg-checkBG font-poppins flex flex-col items-center">
      <div className="flex flex-col justify-center">
        <div className="xl:max-w-[1280px] w-full flex flex-col px-20 mx-auto">
          ...
          <p className="text-xl">CheckMate is a crowdsourced system that monitors messages sent to our CheckMate bot, funnels those in need of verification to our CheckMates, and replies users once we are confident on our categorisation of the message. The CheckMate team has seen really close the negative impact of misinformation and scams in our families, friends, and society as a whole across Singapore and the rest of the world. We had enough and decided to bring it to and end, <strong>one message at a time.</strong></p>

    ...
    <div className="w-full bg-checkBG font-poppins flex flex-col items-center">
      <div className="flex flex-col justify-center">
        <div className="xl:max-w-[1280px] w-full flex flex-col px-20 mx-auto">
          ...
          <h1 className="font-light text-checkPrimary600 ss:text-[56px] text-[48px]">Our Mission Statement</h1>
          <p className="text-xl">In a world where misinformation and scams are commonplace, CheckMate harnesses the power of artificial intelligence coupled with crowdsourcing intelligence through our CheckMates: a network of trusted volunteers who help verify dubious messages that you might come across.</p>

          <h1 className="font-light text-checkPrimary600 ss:text-[48px] text-[32px] mt-12">What is CheckMate?</h1>
          <p className="text-xl">CheckMate is a crowdsourced system that monitors messages sent to our CheckMate bot, funnels those in need of verification to our CheckMates, and replies users once we are confident on our categorisation of the message. The CheckMate team has seen from really close the negative impact of misinformation and scams in our families, friends, and society as a whole across Singapore and the rest of the world. We had enough and decided to bring it to and end, <strong>one message at a time.</strong></p>

          <h1 className="font-light text-checkPrimary600 ss:text-[48px] text-[32px] mt-12">Who are the CheckMates?</h1>
          <p className="text-xl">We rely on our CheckMates, a network of volunteers who help us vote on new messages that you send in to our CheckMate bot. Our CheckMates come from all walks of life, but they are united by a common purpose - to help counter misinformation and scams in the community.</p>


          {/** Our impact section */}
          <div className=" w-full flex flex-col md:flex-row gap-x-12 p-12 items-center">
          ...
          {teamMembers.map((member, index) => (
            <a href={member.linkedin} target="_blank" key={index} className="flex flex-col items-center w-[calc(25%-1.5rem)]">
              ...
              <div className="flex flex-col items-center bg-checkWhite w-full p-2 rounded-b-[36px] shadow-2xl">
                ...
                <div className="font-poppins text-md font-normal">{member.title || ""}</div>
              </div>
            </a>
          ))}
        </div>

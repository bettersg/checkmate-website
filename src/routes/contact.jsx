...
const Contact = () => {
  ...
  return (
    <div id="privacy-policy" className={`flex flex-col items-start font-workSans font-medium`}>
      ...
      <div className="xl:max-w-[1280px] mx-auto w-full flex flex-col items-start px-12 text-checkBlack pt-6">
        <h1 className="flex-1 font-bold text-[48px] font-poppins">Contact Us</h1>
      </div>

...
export const socialMedia = [
  ...
  },
  {
    id: "social-media-2",
    icon: whatsapp,
    link: "https://ref.checkmate.sg/add?utm_source=website&utm_medium=socialbuttons",
    text: "CheckMate WhatsApp Bot",
  },
];
...
export const categories = [
  { id: "checkbox-item-1", text: "scam" },
  { id: "checkbox-item-2", text: "illicit" },
  { id: "checkbox-item-3", text: "untrue" },
  { id: "checkbox-item-4", text: "misleading" },
  { id: "checkbox-item-5", text: "accurate" },
  { id: "checkbox-item-6", text: "spam" },
];
...
export const MESSAGE_DATABASE_API_ENDPOINT =
  "https://checkmate.sg/api/publicmessages";

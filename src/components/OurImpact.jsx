...
const OurImpact = () => {
    ...
    const MessagesChecked = () => (
        <div style={{ width: "100%", height: "100%"}} className="w-full bg-checkWhite shadow-2xl px-12 py-8 rounded-carousel flex flex-col gap-y-4">
            <h2 className="font-bold ss:text-[61px] text-[48px]">
    ...
    const ActiveCheckers = () => (
        <div style={{ width: "100%", height: "100%" }} className="w-full bg-checkSecondaryYellow500 shadow-2xl px-12 py-8 rounded-carousel flex flex-col gap-y-4">

...
const OurImpact = () => {
    ...
    const MessagesChecked = () => (
        <div className="w-full bg-checkWhite shadow-2xl px-12 py-8 rounded-carousel flex flex-col gap-y-4">
            <h2 className="font-bold ss:text-[48px] text-[36px] text-center">
    ...
    const MessagesVerified = () => (
        <div className="w-full bg-checkPrimary600 shadow-2xl px-12 py-8 rounded-carousel flex flex-col gap-y-4">
            <h2 className="font-bold ss:text-[48px] text-[36px] text-center text-white">
    ...
    const ActiveCheckers = () => (
        <div className="w-full bg-checkSecondaryYellow500 shadow-2xl px-12 py-8 rounded-carousel flex flex-col gap-y-4">
            <h2 className="font-bold ss:text-[48px] text-[36px] text-center text-white">

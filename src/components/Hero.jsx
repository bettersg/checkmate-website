    ...
    >
      ...
      >
        ...
        >
          ...
          <p
            className={`${styles.paragraph} max-w-md mt-5 text-checkBlack font-workSans`}
          >
            Not sure if a message can be trusted? Simply forward your message to
            CheckMate and we’ll check it for you!
          </p>

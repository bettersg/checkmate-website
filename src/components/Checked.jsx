      ...
      <div className="flex flex-col md:flex-row w-full gap-x-12 gap-y-8 pt-12">
        <div className="w-full md:w-1/2 bg-checkGray rounded-carousel flex flex-col md:flex-row">
          <div className="flex flex-col w-full md:w-1/2 pl-6 pr-4 md:pr-0 md:pl-12 my-auto mt-10 md:mt-0">
            ...
            <h3 className="md:text-[20px] text-[14px] text-checkDarkGray font-workSans">
              Misinformation, Scams, Surveys, Job offerings, Packages,
        ...
        <div className="w-full md:w-1/2 bg-checkGray rounded-carousel flex flex-col md:flex-row">
          <div className="flex flex-col w-full md:w-1/2 pl-6 pr-4 md:pr-0 md:pl-12 my-auto mt-10 md:mt-0">
            ...
            <h3 className="md:text-[20px] text-[16px] text-checkDarkGray font-workSans">
              QR codes, Flyers, Advertisements, Spam, Screenshots, Deals too
              good to be true
              <br />
              &nbsp;
            </h3>

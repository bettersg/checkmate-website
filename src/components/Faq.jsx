      ...
      <div className="flex flex-col px-0 sm:px-4 md:px-12 xl:max-w-[1080px] w-full items-center font-workSans">
        ...
        >
          ...
          <p className="px-4 py-6 pt-0 mt-4 text-checkGrayModal text-base">
            <span className="font-bold">Absolutely!</span> CheckMate is free to
            use and free for life.
          </p>
        </details>
        ...
        >
          ...
          <div className="px-4 py-6 pt-0 mt-4 text-checkGrayModal flex flex-col gap-y-2 text-base">
            <p>
              When you send a message to CheckMate for checking, the following
              happens:
            </p>
            <h3 className="font-bold underline">Matching</h3>
            <p>
              We check if this message has been received before, after ignoring
              any phone numbers mentioned in the message
            </p>
            <h3 className="font-bold underline">If there is a match</h3>
            <p>
              CheckMate will reply based on the previously-voted classification
              of the message (see section on Voting Options below)
            </p>
            <h3 className="font-bold underline">If there is no match</h3>
            <p>
              Our CheckMates will be triggered to vote on your message.
              CheckMates will vote as such:
            </p>
            <h3 className="font-bold underline">Voting Options</h3>
            <p>
              First, CheckMates decide if the message comes under either of
              these categories
            </p>
            <ol className="list-decimal	pl-6 pb-2">
              <li>
                Scams (Messages intended to obtain money/personal information
                via deception)
              </li>
              <li>
                Suspicious Activity (Messages representing potential illicit
                activity, e.g. moneylending/prostitution)
              </li>
              <li>
                News/Information/Opinion (Messages intended to inform/convince a
            ...
            <p>
              If a CheckMate decide that the message falls under the third
              category (“News/Information/Opinion”), they then choose a number
              from 0-5 to reflect how true they think the message is.
            </p>
            <h3 className="font-bold underline">
              How Voting Determines the Outcome
            </h3>
            <p>Every time a vote comes in, the system does the following:</p>
            <ol className="list-decimal pl-6">
              <li>
                If more than 50% of all votes cast so far are on any one
                category, it is assigned that category
              </li>
              <li>
                If the votes on scams and suspicious activity combined are
                greater than 50%, we assign it whichever of the two categories
                has more votes
              </li>
              <li>
              ...
              <li>
                ...
                are three different thresholds for this
                <ol className="list-alpha pl-6">
                  <li>
                    If the message has been categorised either as scam or as
                    suspicious, it is considered assessed if{" "}
                    <strong>&gt;20%</strong> of CheckMates have voted. This
                    lower threshold is because:
                  ...
                  <li>
                    If our CheckMates are unsure of the message, we only
                    consider it assessed if <strong>&gt;80%</strong> of
                    CheckMates have voted. This high threshold is because we
                    want to give our checkers more time to reach a consensus.
                  </li>
                  <li>
                    Otherwise the message is considered assessed if{" "}
                    <strong>&gt;50%</strong> of fact checkers have voted. This
                    ...
                    <ol className="list-roman pl-6">
                      ...
                      <li>
                        ...
                        more votes allows us to be more confident of the final
                        outcome.
                      </li>
                    </ol>
                  </li>
              ...
              <li>
                ...
                <ol className="list-alpha pl-6">
                  <li>
                    All users that have sent in this message and have not
                    received a reply, will receive a reply based on its tag, or
                    the mean truth score given by our CheckMates, (if message is
                    neither tagged as scam, suspicious, or irrelevant).
                  </li>
                  <li>
                    From now on, users who send in this message will receive an
                    immediate reply based on the prevailing tag / mean truth
        ...
        >
          ...
          <div className="px-4 py-6 pt-0 mt-4 text-checkGrayModal flex flex-col gap-y-4 text-base">
            ...
            <p>
              To get started, please sign up below, or write to us at{" "}
              <a
            ...
            <iframe
              src="https://docs.google.com/forms/d/e/1FAIpQLSdHvf7wPEj7iQinHdQZPUk-7QJhtFPc-GSHlAbZ0C0hOP3jRQ/viewform?embedded=true"
              width="640"
              height="800"
            >
              Loading…
        ...
        >
          ...
          <div className="px-4 py-6 pt-0 mt-4 text-checkGrayModal text-base">
            <p>
              Messaging the CheckMate bot is like messaging someone in Whatsapp.
              CheckMate will only receive{" "}
              <span className="underline font-bold">your number</span> and the{" "}
        ...
        >
          ...
          <div className="px-4 py-6 pt-0 mt-4 text-checkGrayModal space-y-4 text-base">
            <p>
              CheckMate is an independent, non-government initiative supported
              ...
              . We understand that combatting scams and dubious messages
              requires a collaborative approach to safeguard everyone. That's
              why we are currently exploring a partnership with{" "}
              <a
                className="text-checkPrimary600 underline cursor-pointer"
            ...
            <p>
              ...
              , when you send in a message, and our CheckMates identify it as a
              scam, we will ask for your consent to share that specific message
              anonymously with{" "}
              <a
                className="text-checkPrimary600 underline cursor-pointer"
                href="https://scamshield.org.sg/"
              ...
              will include the message in the national scams database in order
              to help fight scams in Singapore.
            </p>
            <p>
              Your consent is sought for each individual message. You may choose
              to share some messages with{" "}
              <a
                className="text-checkPrimary600 underline cursor-pointer"
                href="https://scamshield.org.sg/"
              >
              ...
              , while deciding not to share others. We will seek your consent
              for every message separately.
            </p>
            <p>
              As for your privacy, rest assured that no other information
              CheckMate has access to will be shared. Your phone number and
        ...
        >
          ...
          <div className="px-4 py-6 pt-0 mt-4 text-checkGrayModal space-y-4">
            <p>
              ...
              is an anti-scam product developed by the National Crime Prevention
              Council and Open Government Products.
            </p>
          </div>
        </details>
        <div className="w-[calc(100%-2rem)] md:w-[calc(100%-4rem)] border-b border-gray-300"></div>
        ...
        >
          ...
          <div className="px-4 py-6 pt-0 mt-4 text-checkGrayModal space-y-4 text-base">
            <p>
              CheckMate tries to balance speed and accuracy when it comes to
              assessing messages. To provide a robust answer, we typically
              prefer to have more volunteers assess a message. However, we
              understand speed is of essence for you. We are typically able to
              provide an assessment within hours of receiving your message, and
              are consistently striving to make this timing shorter without
              compromising on the quality of our assessment.
            </p>
            <p>
              We have also introduced mixed-model machine learning to assist
              with the matching and classification of messages, which has
              allowed us to respond faster to a wider variety of messages. If we
              do not respond to your message with an assessment within 24 hours
              of sending it in, please report it{" "}

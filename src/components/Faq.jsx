      ...
      <div className="flex flex-col px-0 sm:px-4 md:px-12 xl:max-w-[1080px] w-full items-center font-workSans">
        ...
        >
          ...
          <div className="px-4 py-6 pt-0 mt-4 text-checkGrayModal space-y-4 text-base">
            <p>CheckMate is an independent, non-government initiative supported by the non-profit organization <a className="text-checkPrimary600 underline cursor-pointer" href="https://better.sg">better.sg</a>. We understand that combatting scams and dubious messages requires a collaborative approach to safeguard everyone. That's why we are currently exploring a partnership with <a className="text-checkPrimary600 underline cursor-pointer" href="https://www.scamshield.org.sg/">ScamShield</a>.</p>

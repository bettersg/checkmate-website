      ...
      <div className="flex flex-col px-0 sm:px-4 md:px-12 xl:max-w-[1080px] w-full items-center font-workSans">
        ...
        >
          <summary className="cursor-pointer px-4 py-6 font-bold list-none">
            <div className="flex flex-row justify-between items-center">
              <span className="p-3 text-checkShadeDark text-xl font-medium">
        ...
        >
          ...
          <div className="px-4 py-6 pt-0 ml-4 -mt-4 text-checkGrayModal space-y-4 text-base">
            ...
            <p>
              Once we have linked up with ScamShield, when you send in a
              message, and our CheckMates identify it as a scam, we will ask for
              your consent to share that specific message anonymously with
              ScamShield. If you agree, ScamShield will include the message in
              the national scams database in order to help fight scams in
              Singapore.
            </p>
            <p>
              Your consent is sought for each individual message. You may choose
              to share some messages with ScamShield, while deciding not to
              share others. We will seek your consent for every message
              separately.
            </p>
            <p>
        ...
        >
          ...
          <div className="px-4 py-6 pt-0 ml-4 -mt-4 text-checkGrayModal space-y-4">
            <p>
              <a href="https://www.scamshield.org.sg/">ScamShield</a> is an
              anti-scam product developed by the National Crime Prevention

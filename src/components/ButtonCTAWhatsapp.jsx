  ...
  return (
    <>
      <a
        ...
        className="cursor-pointer flex flex-row items-center justify-center gap-x-4 bg-checkGreen font-poppins rounded-[10px] px-5 py-4 text-center max-w-sm w-full"
      >
        <img src={whatsapp} />
